<?php
    ...
    class OrganizationController extends Controller {
        ...
        public function index() {
            ...
            return view('organization.index', compact('applicants', 'pending_applicant', 'sched_applicant', 'reject_applicant', 'job_active', 'closed_job', 'deleted_job'));
        }
        ...
        public function profile() {
            ...
            return view('organization.profile.index', compact('otc', 'users', 'image', 'subscription'));
        }
        ...
        public function show($id) {
            ...
            return view('organization.profile.details', compact('users'));
        }
        ...
        public function edit($id) {
            ...
            return view('organization.profile.details_edit', compact('countries', 'industry', 'users', 'types'));
        }
