<?php
    ...
    class AffilationController extends Controller {
        ...
        public function index() {
            ...
            return view('school.affilations.index', compact('affilations'));
        }
        ...
        public function create() {
            ...
            /*get all user's with the same roles*/
            ...
            return view('school.affilations.create', compact('users'));
        }
        ...
        public function store(Request $request) {
            ...
            try {
                ...
                return redirect('school/affilations');
            } 
