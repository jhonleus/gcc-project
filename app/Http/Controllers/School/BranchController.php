<?php
    ...
    class BranchController extends Controller {
        ...
        public function index() {
            ...
            return view('school.branches.index', compact('branches'));
        }
        ...
        public function create() {
            ...
            return view('school.branches.create', compact('countries'));
        }
        ...
        public function edit($id) {
            ...
            return view('school.branches.create', compact('countries', 'branch'));
        }
        ...
        public function store(Request $request) {
            ...
            try {
                ...
                return redirect('school/branches');
            } 
