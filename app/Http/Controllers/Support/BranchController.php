<?php
    ...
    class BranchController extends Controller {
        ...
        public function index() {
            ...
            return view('support.branches.index', compact('branches'));
        }
        ...
        public function create() {
            ...
            return view('support.branches.create', compact('countries'));
        }
        ...
        public function edit($id) {
            ...
            return view('support.branches.create', compact('countries', 'branch'));
        }
