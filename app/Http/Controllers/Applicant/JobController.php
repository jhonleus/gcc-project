<?php
	...
	class JobController extends Controller {
	    ...
	    public function index() {
			...
			return view('applicant.jobs.index', compact("jobs", 'approves', 'rejects', 'pending'));
	    }
	    ...
	    public function jobs() {
	        ...
	        return view('applicant.jobs.saved', compact('bookmarks'));
	    }

	    public function show($id) {
	    	$profile = UserApplication::with("employer", "application", "response", "company_documents")->where("id", $id)->first();

			return view('applicant.jobs.information', compact("profile"));
	    }
	    ...
	    public function store(Request $request) {
	        ...
	        try {    
		        ...
		        if($appliedStatus) {
			        ...
			        $subject2 = "Application for " . $cdetail->title;
			        $message2 = "Hi! Thank you for your attention and interest on the profile of this <b>".$receiver_name."</b>. <br><br>May we remind you about the existing rules of the Philippine Overseas Employment Administration (POEA), to apply for overseas employment, only through a POEA-licensed Philippine recruitment agency. It is the agency which communicates with prospective Employers needing Filipino workers.<br><br>To be guided about safe job application procedures, please contact any of the certified Philippine Sending Organization in this platform.<br><br>Yours truly,<br><b>GCC</b>";

			        /*parameters for sending email*/
			        $emailArray2 = array("receiver_email" => Auth::user()->email,
			        					"receiver_name" => Auth::user()->firstName." ".Auth::user()->lastName,
			        					"message" => $message2,
			        					"subject" => $subject2);
	    ...
	    public function invitations() {
	        ...
	        return view('applicant.jobs.invitations', compact('jobs', 'approves', 'rejects'));
	    }
