<?php
    ...
    class WorkController extends Controller {
        ...
        public function index() {   
            ...
            return view('applicant.works.index', compact('works'));
        }
     
        public function create() {
            $countries  = ExtraCountry::orderBy('nicename')->get();

            return view('applicant.works.create', compact('countries'));
        }
        ...
        public function edit($id) {
            ...
            return view('applicant.works.create', compact('countries', 'work'));
        }
