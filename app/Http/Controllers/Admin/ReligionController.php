...
class ReligionController extends Controller
{
    ...
    public function index()
    {
        ...
        $extras = ExtraReligion::all();
        return view('admin.maintenance.religion', compact('extras'));
    }
    ...
    {
        ExtraReligion::findOrFail($id)->delete();
