...
class PositionController extends Controller
{
    ...
    {
        $extras = ExtraPosition::all();
        return view('admin.maintenance.position', compact('extras'));
    }
    ...
    {
        ExtraPosition::findOrFail($id)->delete();
