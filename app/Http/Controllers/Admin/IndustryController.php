...
class IndustryController extends Controller
{
    ...
    public function index()
    {
        ...
        $extras = ExtraIndustry::all();
        return view('admin.maintenance.industries', compact('extras'));
    }
    ...
    {
        ExtraIndustry::findOrFail($id)->delete();
