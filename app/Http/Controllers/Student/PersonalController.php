...
class PersonalController extends Controller
{
    public function index() {   
    	...
    	return view('student.profile.personal', compact('specializations', 'user', 'hobbies', 'locations'));
    }
    ...
    {   
        ...
        return view('student.profile.personal_edit', compact('specializationTags', 'specializations', 'locationTags', 'hobbiesTags', 'users', 'genders', 'civils', 'religions', 'countries', 'hobbies', 'currencies', 'types', 'results')); 
    }
