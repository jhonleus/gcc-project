<?php
    ...
    class EducationController extends Controller
    {
        public function index() {   
            ...
            return view('student.educations.index', compact('educations'));
        }
        ...
        public function create() {   
            ...
            return view('student.educations.create', compact('levels', 'countries'));
        }
        ...
        public function edit($id) {   
            ...
            return view('student.educations.create', compact('levels', 'countries', 'education'));
        }
