    ...
    class ApplicantController extends Controller {
        ...
        public function index() {
            ...
            if(Auth::user()->rolesId == 4) {
                ...
                $users = User::with('details', 'address', 'contacts', 'documents', 'applications')->where("users.rolesId", 1)->paginate(10);
        ...
        public function search() {
            ...
            if (!empty($get_title)) {
                $users =    $users->where(function($q) use($get_title) {
                                $q->whereHas('applications', function($r) use($get_title) {
                                    $r->join('employer_jobs', "user_applications.jobId", '=', "employer_jobs.id")->where('employmentId', $get_title);
                                });
                            });
            }
