<?php
    ...
    class RecruiterController extends Controller {
        ...
        public function index() {
            ...
            $users = User::whereHas('employerdetails')->where("rolesId", 3)->paginate(10);

    		return view('employer.recruiters.index', compact('search', 'country', 'industries', 'users'));
        }
        ...
        public function search() {
            ...
            $users = User::query()->whereHas('employerdetails')->where("rolesId", 3);
            ...
            return view('employer.recruiters.index', compact('search', 'get_ind', 'get_loc', 'users', 'industries', 'country'));
        }
    }
?>
