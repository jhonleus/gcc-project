<?php
    ...
    class BranchController extends Controller {
        ...
        public function index() {
            ...
            return view('employer.branches.index', compact('branches'));
        }
        ...
        public function create() {
            ...
            return view('employer.branches.create', compact('countries'));
        }
        ...
        public function edit($id) {
            ...
            return view('employer.branches.create', compact('countries', 'branch'));
        }
        ...
        public function store(Request $request) {
            $attributes = request()->validate([
           	...
           	try {
                ...
                return redirect('employer/branches');
           	} 
