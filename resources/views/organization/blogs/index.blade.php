									...
									<div class="row">
										...
										<div class="col-sm-5">
											<p class="content-right">
												<form style="float:right;" action="/organization/blogs/{{ $blog->id }}" method="POST" onsubmit="return confirm('{{ App\MaintenanceLocale::getLocale(151) }}')">
													@csrf
													@method('DELETE')
													<a class="label-blue label-button" href="{{ url('organization/blogs/'.$blog->id.'/edit') }}">
