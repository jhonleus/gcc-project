						...
						<div class="row">
							<div class="col-sm-6">
		                    	...
		                    	<div style="display:block">
		                    		...
		                    		<a href="{{url("organization/summary/applicants/".$job->id) }}" class="job-action" target="_blank">
		                    			view summary
		                    		</a>
							...
							<div class="col-sm-2 text-center">
								<a class="jobs-label" href="{{ url("organization/summary/applicants/unprocessed/".$job->id) }}" target="_blank">{{$job->unprocessed()}}
									<label class="jobs-title">UNPROCESSED</label>
								</a>
							</div>

							<div class="col-sm-2 text-center">
								<a class="jobs-label" href="{{ url("organization/summary/applicants/interview/".$job->id) }}" target="_blank">{{$job->interview()}}
									<label class="jobs-title">INTERVIEW</label>
								</a>
							</div>

							<div class="col-sm-2 text-center">
								<a class="jobs-label" href="{{ url("organization/summary/applicants/rejected/".$job->id) }}" target="_blank">{{$job->rejected()}}
