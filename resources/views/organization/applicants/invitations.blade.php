...
@section('content')
	...
	<div class="container page-container">
		...
		@else
			@if($canSendEmail < 1)
				<div class="alert alerts alert-warning" role="alert">
					Your subscription has no email to applicant, upgrade your subscription <a href="{{ url('pricing') }}">here</a>!
				</div>
			@endif
		@endif
						...
						<div class="card page-contents">
							<div class="card-body page-content-body">
								<div class="content-header-1">
									...
									<a href="{{url("jobs/".Crypt::encrypt($user->jobId)) }}" class="content-actions" target="_blank">
										{{ $user->jobs->title }}
									</a>
								</div>
								...
								<div class="content-footer">
									<label class="label-date text-uppercase">{{ App\MaintenanceLocale::getLocale(382) }}: {{Helper::getDate($user->scheduled)}}</label>
								</div>
							</div>
						</div>
						@endforeach
	...
	<script> 
		$(document).ready(function(){
			$("#invitation-list").removeClass("sidebar-list-title");
			$("#invitation-list").addClass("sidebar-list-title-active");
		});
