...
@section('content')
	<div class="container page-container">
		...
		<div class="alert alerts alert-warning" role="alert">
			{{ App\MaintenanceLocale::getLocale(313) }} <a href="{{ url('organization/details/'.Auth::user()->id.'/edit') }}">{{ App\MaintenanceLocale::getLocale(314) }}</a>!
		</div>
		@endif
		<div class="row">
			<div class="col-sm-3">
						...
						<div class="row">
							<div class="col-sm-4 show-image">
								@if ($image)
									...
									<form id="savepic" action="{{ route('organization.details.store') }}" method="POST" style="display: none;" enctype="multipart/form-data">
							  		@csrf
