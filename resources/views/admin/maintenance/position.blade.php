...
@section('title', App\MaintenanceLocale::getLocale(26))
     ...
     <div class="col-md-12">
      ...
      <div class="card shadow-none mt-5">
        <div class="card-header">
          <h6 style="float:left; margin-top:10px">{{ App\MaintenanceLocale::getLocale(26) }}</h6>
              ...
              <table class="table table-bordered" id="dataTable">
                ...
                <tbody>
                  ...
                  <tr class="data-row">
                    ...
                    <td>
                      <form action="/admin/position/{{ $extra->id }}" method="POST" onsubmit="return confirm('{{ App\MaintenanceLocale::getLocale(151) }}')">
                        @csrf
                        @method('DELETE')
...
<div class="modal fade" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="edit-modal-label" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form method="POST" id="edit-form" action="{{ route('admin.position.store') }}">
        @csrf
