		...
		<div class="card shadow-none col-12 p-0">
      		<h5 class="font-weight-bold p-2">Blog list</h5>
				<table class="table table-hover">
  					<thead>
    					<tr>
      						<th scope="col">{{ App\MaintenanceLocale::getLocale(30) }}</th>
      						<th scope="col">{{ App\MaintenanceLocale::getLocale(31) }}</th>
      						<th scope="col">{{ App\MaintenanceLocale::getLocale(32) }}</th>
      						<th scope="col">{{ App\MaintenanceLocale::getLocale(36) }}</th>
       						<th scope="col">{{ App\MaintenanceLocale::getLocale(37) }}</th>
    					</tr>
  					</thead>
  					<tbody>
    					<tr>
