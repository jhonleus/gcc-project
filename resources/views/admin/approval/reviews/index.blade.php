...
@section('title', App\MaintenanceLocale::getLocale(407))
  ...
  <div class="maintenancesection1">
    <div class="row">
     <div class="col-md-12">
      ...
      <h3 class="m-0 text-dark pt-3" style="float:left">{{ App\MaintenanceLocale::getLocale(407) }}</h3>
    ...
    <div class="col-md-12">
      <div class="card shadow-none job-contents mt-3">
        <div class="nav-tabs-wrapper">
         ...
         <li class="nav-item">
           <a class="nav-link" href="#approved" data-toggle="tab">{{ App\MaintenanceLocale::getLocale(273) }} <span class="badge badge-light ml-2">{{$approved->count()}}</span></a>
         </li>
         
         <li class="nav-item">
           <a class="nav-link" href="#rejected" data-toggle="tab">{{ App\MaintenanceLocale::getLocale(274) }} <span class="badge badge-light ml-2">{{$rejected->count()}}</span></a>
         </li>
            ...
            <table class="table table-bordered" id="dataTable1" style="width:100%">
              <thead>
                <tr>
                  ...
                  <th>{{ App\MaintenanceLocale::getLocale(506) }}</th>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    @if(!is_null($review->users))
                    @if($review->users->rolesId==4)
                  ...
                  <td>
                    @if(!is_null($review->users))
                    @if(!is_null($review->users->roles))
                    {{$review->users->roles->getName()}}
                    @endif
                    @endif                                
                  </td>
                  <td>{{$review->summary}}</td>
                  <td><a href="/admin/reviews/{{Crypt::encrypt($review->id)}}/edit" class="btn btn-default register">View Review</button></td>
                </tr>
                @endforeach
