...
<div class="container pt-5">
		<h5 class="mb-4">Approvals Overview</h5>
	<div class="row mb-5">
	...
	<div class="row">
		<div class="col-md-6 col-6">
			<div class="card shadow-none">
				<div class="card-body">
					<div class="row">
						<div class="col-md-3"><img width="100%"  class="img-fluid  admin-dasboard-page-img" alt="Responsive image" src="{{ asset('admin dashboard logo/target.svg')}}">
						</div>
		...
		<div class="col-md-6 col-6">
			<div class="card shadow-none">
				<div class="card-body">
					<div class="row">
						<div class="col-md-3"><img width="100%" class="img-fluid admin-dasboard-page-img" src="{{ asset('admin dashboard logo/building.svg')}}"></div>
							<div class="col-md-6 mx-auto">
								<br>
	...
	<div class="row">
		<div class="col-md-6 col-6">
			<div class="card shadow-none">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-3"><img class="img-fluid admin-dasboard-page-img" src="{{ asset('admin dashboard logo/collaboration.svg')}}"></div>
							<div class="col-md-6 mx-auto">
								<br>
		...
		<div class="col-md-6 col-6">
			<div class="card shadow-none">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-3"><img width="100%" class="img-fluid admin-dasboard-page-img" src="{{ asset('admin dashboard logo/graduation-hat.svg')}}"></div>
							<div class="col-md-6 mx-auto">
								<br>
