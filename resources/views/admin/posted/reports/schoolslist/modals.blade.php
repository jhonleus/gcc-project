<!-- Modal -->
  <div class="modal fade" id="editSchoolslist" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
            <div class="row">
              <label for="name">{{ __('School ID') }}</label>
            </div>
          <div class="row mt-2">
          ...
          <div class="row mt-2">
           ...
           <div class="row">
            <label for="name">{{ __('School Type') }}</label>
          </div>
          <div class="row mt-2">
