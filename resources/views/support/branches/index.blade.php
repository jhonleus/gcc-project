					...
					<div class="card-header content-header-3">
						<div class="row">
							...
							<div class="col-sm-5 content-right-actions">
								<a href="{{ url('organization/branches/create') }}" class="label-button">
							...
							<div class="col-sm-3">
		                    	<div class="text-right">
    		                    	...
    		                    	<p class="content-right" style="margin-right:6px;">
    		                    		<a class="label-blue" href="{{ url('organization/branches/'.$branch->id.'/edit') }}">
	...
	<script>
		...
		$(".verify-branch").click(function() {
        	...
        	$.ajax({
        	    ...
        	    type : "POST",
        	    url  : `${basePath}/organization/verifyBranch`,
        	    dataType : "json",
        	    data : {
        	        id	: 	id
        	    },
