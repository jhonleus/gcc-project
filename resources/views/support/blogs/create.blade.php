		...
		<div class="row">
			...
			<div class="col-sm-8">
				<div class="card sidebar-settings">
					...
					<div class="card-body">
						@if(isset($blogs))
					<form method="POST" action="{{ route('support.blogs.update', $blogs->id) }}" enctype="multipart/form-data">
						@method('PUT')
						@csrf
					...
					@else
					<form method="POST" action="{{ route('support.blogs.store') }}" enctype="multipart/form-data">  
						@csrf
					@endif
            			<div class="contents-form">
