					...
					<div class="card-header content-header-3">
						<div class="row">
							...
							<div class="col-sm-5 content-right-actions">
								<a href="{{ url('employer/affilations/create') }}" class="label-button">
									...
									@if(!is_null($affilation->co_documents))
										@foreach($affilation->co_documents as $file)
											@if($file->filetype==="profile")
												<img class="label-image" src="{{ url($file->path . $file->filename)}}">
											@endif
										@endforeach
									@else
										<img class="label-image" src="{{ url('/images/user_img.png') }}">
									@endif
								@else
	...
	<script>
		...
		$(".verify-affilation").click(function() {
        	...
        	$.ajax({
        	    ...
        	    type : "POST",
        	    url  : `${basePath}/employer/verifyAffilation`,
        	    dataType : "json",
        	    data : {
        	        id	: 	id
        	    },
