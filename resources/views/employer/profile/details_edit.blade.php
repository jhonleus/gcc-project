...
@section('title', App\MaintenanceLocale::getLocale(316))
...
@section('content')
	...
	<div class="container page-container">
		<div class="row">
			...
			<div class="col-sm-9">
				<form method="POST" action="{{ route('employer.details.update', $users->id) }}" id="form">
				@method('PUT')
				@csrf
				<div class="card page-title">
					<div class="card-header card-header-1">
						<label class="label-information">{{ App\MaintenanceLocale::getLocale(316) }}</label>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-sm-6"> 
							...
							<div class="col-sm-6">
								<div class="contents-form">
									<h1 class="label-select">{{ App\MaintenanceLocale::getLocale(146) }}:</h1>
