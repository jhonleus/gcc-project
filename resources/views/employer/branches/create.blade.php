		...
		<div class="row">
			...
			<div class="col-sm-9">
				<div class="card page-title">
					...
					@if(isset($branch))
					<form method="POST" action="{{ route('employer.branches.update', $branch->id) }}" id="form">
			            @method('PUT')
					    @csrf
					@else
					<form method="POST" action="{{ route('employer.branches.store') }}" id="form">
					@csrf
					@endif
					<div class="card-body">
						<div class="row">
							<div class="col-sm-6">
								<div class="contents-form">
									<label class="label-select">{{ App\MaintenanceLocale::getLocale(563) }}:</label>
									...
									<div class="error-container">
										<label class="label-error error-branch_name">{{ App\MaintenanceLocale::getLocale(564) }}</label>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="contents-form">
									<label class="label-select">{{ App\MaintenanceLocale::getLocale(187) }}:</label>
									...
									<div class="error-container">
										<label class="label-error error-contact_number">{{ App\MaintenanceLocale::getLocale(446) }}</label>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="contents-form">
									<label class="label-select">{{ App\MaintenanceLocale::getLocale(332) }}:</label>
									...
									<div class="error-container">
										<label class="label-error error-country">{{ App\MaintenanceLocale::getLocale(343) }}</label>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="contents-form">
									<label class="label-select">{{ App\MaintenanceLocale::getLocale(331) }}:</label>
								
									<input class="input" id="city" name="city" value="@if($errors->any()){{ old('city') }}@else @if(isset($branch)){{$branch->city}}@endif @endif">

									<div class="error-container">
										<label class="label-error error-city">{{ App\MaintenanceLocale::getLocale(345) }}</label>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="contents-form">
									<label class="label-select">{{ App\MaintenanceLocale::getLocale(330) }}:</label>
								
									<input class="input" id="street" name="street" value="@if($errors->any()){{ old('street') }}@else @if(isset($branch)){{$branch->street}}@endif @endif">

									<div class="error-container">
										<label class="label-error error-street">{{ App\MaintenanceLocale::getLocale(344) }}</label>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="contents-form">
									<label class="label-select">{{ App\MaintenanceLocale::getLocale(333) }}:</label>
								
									<input class="input" id="code" name="code" value="@if($errors->any()){{ old('code') }}@else @if(isset($branch)){{$branch->zipcode}}@endif @endif">

									<div class="error-container">
										<label class="label-error error-code">{{ App\MaintenanceLocale::getLocale(346) }}</label>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="content-footer-2">
							<button class="btn label-button btn-primary" id="save_button">@if(isset($branch)) {{ App\MaintenanceLocale::getLocale(38) }} @else{{ App\MaintenanceLocale::getLocale(35) }} @endif</button>
						</div>
					</div>
				</div>
				</form>
