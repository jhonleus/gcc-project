...
@section('title', 'Match Applicants')
...
@section('content')
	...
	<div class="container applicant-container">
		<h1 class="text-center">{{ $jobs->title }}</h1>
						...
						<div class="row">
							...
							<div class="col-sm-8">
								...
								<label class="applicant-details">
									...
									+{{$user->contacts ? $user->contacts->country ? $user->contacts->country->phonecode : "" : ""}} {{$user->contacts ? $user->contacts->number : ""}} 
								</label>
								...
								@if(!is_null($user->documents))
									...
									<label class="content-details">
										...
										<a href="{{ url($document->path . $document->filename)}}" class="label-chinese" target="_blank">
